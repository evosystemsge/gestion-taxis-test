...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT id, nombre, email, password, rol FROM usuarios WHERE nombre = ?");
...
<head>
    ...
    <style>
        ...
        .logo img {
            ...
            /* Borde de 2px de color negro, puedes cambiarlo */
            border-radius: 5px;
            /* Borde redondeado, puedes ajustarlo o eliminarlo */
            padding: 10px;
            /* Espaciado dentro del borde, puedes ajustarlo */
            box-sizing: border-box;
            /* Asegura que el padding y borde no afecten el tamaño total */
        }
