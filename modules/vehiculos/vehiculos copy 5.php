        ...
        if (vehiculo[imgField]) {
            ...
            previewDiv.innerHTML = `
                <div style="margin-top: 5px;">
                    <img src="../../uploads/vehiculos/${vehiculo[imgField]}" 
...
function verVehiculo(vehiculo) {
    ...
    let imagenesHTML = '<div class="vehicle-images"><h4>Imágenes del Vehículo</h4><div class="images-container">';
            ...
            imagenesHTML += `
                <div class="image-item">
                    <img src="../../imagenes/vehiculos/${vehiculo[imgField]}" 
                         onclick="ampliarImagen('../../imagenes/vehiculos/${vehiculo[imgField]}')">
                    <div>Imagen ${i}</div>
                </div>
            `;
        }
    ...
    document.getElementById('detalleVehiculo').innerHTML = html + imagenesHTML;
    document.getElementById('modalVer').style.display = 'block';
}

// Función para ampliar imágenes al hacer clic
