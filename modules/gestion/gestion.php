...
<body>
    <div class="container">
        ...
        <div class="modal" id="modalNuevoPrestamo">
            ...
            <div class="modal__container">
                ...
                <form id="formNuevoPrestamo" method="post" action="deudas.php">
        ...
        <div class="modal" id="modalNuevaAmonestacion">
            ...
            <div class="modal__container">
                ...
                <form id="formNuevaAmonestacion" method="post" action="deudas.php">
                    <div class="modal__body">
                        <div class="modal__form-group">
                            <label class="modal__form-label">Conductor</label>
                            <select name="conductor_id" class="modal__form-input" required>
    ...
    // Aplicar filtros cuando cambian los controles de fecha y monto
