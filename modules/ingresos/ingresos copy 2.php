...
if (isset($_POST['accion'])) {
    ...
    if ($accion == 'agregar') {
        ...
        $stmt = $pdo->prepare("INSERT INTO ingresos (monto, fecha, kilometros, conductor_id, tipo_ingreso, caja_id) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$monto, $fecha, $kilometros, $conductor_id, $tipo_ingreso, $caja_id]);
